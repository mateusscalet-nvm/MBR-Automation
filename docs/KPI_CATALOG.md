...
| **Non-Brand Levers** | Sources que construyen demanda nueva (Nivel 4 — Non-Branded): Performance No Brand, Organic Growth, Affiliates, Partners, Misc Sources. Ver §3.4 |
| **Misc Sources** | Agregación de sources individualmente poco significativas (Nivel 2): Brand & Comms, Eea, Enp, Mandae, Mid-market, Others, Product Marketing, Store Referral. Ver §3.4 |
| **Performance (Nivel 3)** | Mecánica de adquisición con medios pagos atribuibles: Performance Brand + Performance No Brand |
| **Organic (Nivel 3)** | Mecánica de adquisición sin medios pagos directos: Direct, Organic, Organic Growth, Nurturing |
...
→ Para la jerarquía de agrupamiento (Misc Sources · Performance/Organic/Indirect · Branded/Non-Branded), ver **§3.4 Jerarquía de mkt_source**.
...
- **Nivel 2** — consolidación: las 8 sources de bajo volumen individual se agrupan en **Misc Sources** (Nurturing se mantiene como source propia), resultando en **9** valores
- **Nivel 3** — agrupamiento por **mecánica de adquisición** (4 valores): Performance · Organic · Indirect · Misc Sources
- **Nivel 4** — agrupamiento por **relación con la marca** (2 valores): Branded · Non-Branded

| Nivel 1 (mkt_source — 16) | Nivel 2 (9) | Nivel 3 (4) | Nivel 4 (2) |
|---|---|---|---|
...
| Nurturing | Nurturing | Organic | Non-Branded |
| Brand & Comms | Misc Sources | Misc Sources | Non-Branded |
| Eea | Misc Sources | Misc Sources | Non-Branded |
| Enp | Misc Sources | Misc Sources | Non-Branded |
| Mandae | Misc Sources | Misc Sources | Non-Branded |
| Mid-market | Misc Sources | Misc Sources | Non-Branded |
| Others | Misc Sources | Misc Sources | Non-Branded |
| Product Marketing | Misc Sources | Misc Sources | Non-Branded |
| Store Referral | Misc Sources | Misc Sources | Non-Branded |
...
**Notas:**
- "Others" en el Nivel 1 no se descarta — pasa a formar parte del **Misc Sources** en el Nivel 2
...
- **Nivel 2** (9 sources, con Misc Sources) — estándar para tablas/charts de reportes
- **Nivel 3** (4 categorías — Performance · Organic · Indirect · Misc Sources) — mecánica de adquisición
...
| Tratar "Misc Sources" como "Others" en el Nivel 1 | Misc Sources solo existe a partir del Nivel 2 | Conceptos distintos |
...
WITH mapped AS (
  SELECT
    mkt_source AS source_l1,
    -- Nivel 2: Misc Sources consolida sources poco significativas (Nurturing NO entra)
    CASE
    ...
    CASE
      ...
      WHEN mkt_source IN ('Direct','Organic','Organic Growth','Nurturing')      THEN 'Organic'
...
| B3 | **Sources extras de `mkt_source`** | Acquisition | 8 sources caen en "Misc Sources". Validar con Ops si alguna merece subir al Nivel 2 como source propia (Nurturing ya fue promovida). |
...
| **Non-Brand Levers** | Sources que constroem demanda nova (Nível 4 — Non-Branded): Performance No Brand, Organic Growth, Affiliates, Partners, Misc Sources. Ver §3.4 |
| **Misc Sources** | Agregação de sources individualmente pouco significativas (Nível 2): Brand & Comms, Eea, Enp, Mandae, Mid-market, Others, Product Marketing, Store Referral. Ver §3.4 |
| **Performance (Nível 3)** | Mecânica de aquisição com mídia paga atribuível: Performance Brand + Performance No Brand |
| **Organic (Nível 3)** | Mecânica de aquisição sem mídia paga direta: Direct, Organic, Organic Growth, Nurturing |
...
→ Para a hierarquia de agrupamento (Misc Sources · Performance/Organic/Indirect · Branded/Non-Branded), ver **§3.4 Hierarquia de mkt_source**.
...
- **Nível 2** — consolidação: as 8 sources de baixo volume individual são agrupadas em **Misc Sources** (Nurturing permanece como source própria), resultando em **9** valores
- **Nível 3** — agrupamento por **mecânica de aquisição** (4 valores): Performance · Organic · Indirect · Misc Sources
- **Nível 4** — agrupamento por **relação com a marca** (2 valores): Branded · Non-Branded

| Nível 1 (mkt_source — 16) | Nível 2 (9) | Nível 3 (4) | Nível 4 (2) |
|---|---|---|---|
| Direct | Direct | Organic | Branded |
| Organic | Organic | Organic | Branded |
| Performance Brand | Performance Brand | Performance | Branded |
...
**Notas:**
- "Others" no Nível 1 não é descartada — vira parte do **Misc Sources** no Nível 2
...
- **Nível 2** (9 sources, com Misc Sources) — padrão para tabelas/charts de relatórios
- **Nível 3** (4 categorias — Performance · Organic · Indirect · Misc Sources) — mecânica de aquisição
...
| Tratar "Misc Sources" como "Others" no Nível 1 | Misc Sources só existe a partir do Nível 2 — é a consolidação de 8 sources, incluindo a própria `Others` | Conceitos distintos: `Others` (Nível 1) é uma source raw; `Misc Sources` (Nível 2+) é um bucket de consolidação |
...
| B3 | **Sources extras de `mkt_source`** | Acquisition | 8 sources (`Brand & Comms`, `Eea`, `Enp`, `Mandae`, `Mid-market`, `Others`, `Product Marketing`, `Store Referral`) caem em "Misc Sources". Validar com Ops se outras merecem subir ao Nível 2 como source própria (Nurturing já foi promovida). |
...
- **2026-06-09** — (10ª iteração) Bucket renomeado **`Low Volume` → `Misc Sources`**. **Nurturing promovida** de Misc para source própria no Nível 2 (Nível 3 = Organic, Nível 4 = Non-Branded). Nível 2 passa de 8 → **9 valores**; Misc Sources consolida agora 8 sources. Reordenada a tabela §3.4 (Affiliates/Partners acima de Organic Growth; Nurturing logo abaixo). Atualizados glossário, SQL §9.4, anti-patterns, backlog B3 e `config.py` (`level3()` adicionado). Ambos os idiomas.
...
- **2026-06-02** — (4ª iteração) **Hierarquia formal de 4 níveis para `mkt_source`** definida (§3.4 reescrita com tabela completa 16 → 8 → 4 → 2): Nível 1 raw (16), Nível 2 com Misc Sources (8), Nível 3 mecânica de aquisição (Performance · Organic · Indirect · Misc Sources), Nível 4 relação com marca (Branded · Non-Branded). Glossário §1.1 expandido com Misc Sources + Performance/Organic/Indirect. SQL snippet §9.4 ganhou CTE com mapping CASE para todos os níveis. Anti-patterns §8.4 ganharam alertas sobre mistura de níveis e Others vs Misc Sources.
