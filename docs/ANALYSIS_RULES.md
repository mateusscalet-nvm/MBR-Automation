...
### 7.1 Terminology
Use the canonical terms from `KPI_CATALOG.md` §1: Phoenix (New/Old), Branded / Non-Branded Levers, ICP, Seller vs Non-Seller, Net Adds, mean-click, Long Tail. Never invent synonyms. Use the catalog's canonical KPI names verbatim.
